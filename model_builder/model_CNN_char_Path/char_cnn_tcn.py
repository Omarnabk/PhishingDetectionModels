...
class CharTCN(object):
    ...
    def train(self, training_inputs, training_labels,
        ...
        """
        # Create callbacks
        # tensorboard = TensorBoard(log_dir='./logs_tcn', histogram_freq=checkpoint_every, batch_size=batch_size,
        ...
        # save_history(history=history.history, path='./model_tcn/')

        # # serialize model to JSON
        # model_json = self.model.to_json()
        # with open("model_tcn/model.json", "w") as json_file:
        #     json_file.write(model_json)
        # # serialize weights to HDF5
        # self.model.save_weights("model_tcn/model.h5")
